...
import 'package:color_wala_admin/widget/neoMatchWidget.dart';
...
class FizzMatchScreen extends StatefulWidget {
  const FizzMatchScreen({super.key});

  @override
  State<FizzMatchScreen> createState() => _FizzMatchScreenState();
}

class _FizzMatchScreenState extends State<FizzMatchScreen> {
  String matchCategory = "FIZZ";
  @override
      ...
      children: [
        ...
        FutureBuilder(
          future: FirebaseFirestore.instance
              ...
              .doc(FirebaseKey.fizz)
              .collection(FirebaseKey.fizz)
