...
class FizzTabb extends StatefulWidget {
  const FizzTabb({super.key});

  @override
  State<FizzTabb> createState() => _FizzTabbState();
}

class _FizzTabbState extends State<FizzTabb> {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      gameNameSlogan(matchCategory, "5:00 Min Match"),
                      Column(
