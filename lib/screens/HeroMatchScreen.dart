...
class HeroMatchScreen extends StatefulWidget {
  const HeroMatchScreen({super.key});

  @override
  State<HeroMatchScreen> createState() => _HeroMatchScreenState();
}

class _HeroMatchScreenState extends State<HeroMatchScreen> {
  String matchCategory = "HERO";
  @override
      ...
      children: [
        ...
        FutureBuilder(
          future: FirebaseFirestore.instance
              ...
              .doc(FirebaseKey.hero)
              .collection(FirebaseKey.hero)
